...
<div class="main-header">
    ...
    <p>Tác giả: Lê Mạnh Linh - Trường Tiểu học Hùng Thắng - ĐT: 0989 356 562</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lê Mạnh Linh - Trường Tiểu học Hùng Thắng - ĐT: 0989 356 562</div>", unsafe_allow_html=True)